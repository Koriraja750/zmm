...
𝗧𝗚 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 𝗦𝘁𝗮𝘁𝘂𝘀:<b>{IS_PREMIUM_USER}</b>

𝗟𝗲𝗲𝗰𝗵 𝗧𝘆𝗽𝗲        : <b>{ltype}</b>
𝗟𝗲𝗲𝗰𝗵 𝗣𝗿𝗲𝗳𝗶𝘅       :<b>{lprefix}</b>
𝗟𝗲𝗲𝗰𝗵 𝗦𝘂𝗳𝗳𝗶𝘅       :<b>{lsuffix}</b>
𝗟𝗲𝗲𝗰𝗵 𝗖𝗮𝗽 𝗙𝗼𝗻𝘁    :<b>{lcapfont}</b>
𝗟𝗲𝗲𝗰𝗵 𝗦𝗽𝗹𝗶𝘁 𝗦𝗶𝘇𝗲    :<b>{split_size}</b>
𝗟𝗲𝗲𝗰𝗵 𝗗𝗲𝘀𝘁        :<b>{leech_dest}</b>
𝗠𝗲𝘁𝗮𝗱𝗮𝘁𝗮 𝗧𝗲𝘅𝘁     :<b>{metatxt}</b>
𝗔𝘁𝘁𝗮𝗰𝗵𝗺𝗲𝗻𝘁 𝗨𝗿𝗹    :<b>{attachmenturl}</b>

𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹         : <b>{thumbmsg}</b>
𝗧𝗵𝘂𝗺𝗯 𝗟𝗮𝘆𝗼𝘂𝘁     :<b>{thumb_layout}</b>
𝗘𝗾𝘂𝗮𝗹 𝗦𝗽𝗹𝗶𝘁𝘀       :<b>{equal_splits}</b>
𝗠𝗲𝗱𝗶𝗮 𝗚𝗿𝗼𝘂𝗽      : <b>{media_group}</b>
𝗨𝗽𝗹𝗼𝗮𝗱 𝗖𝗹𝗶𝗲𝗻𝘁      : <b>{leech_method} session</b>
𝗛𝘆𝗯𝗿𝗶𝗱 𝗨𝗽𝗹𝗼𝗮𝗱     : <b>{mixed_leech}</b>

𝗥𝗰𝗹𝗼𝗻𝗲 𝗖𝗼𝗻𝗳𝗶𝗴      :<b>{rccmsg}</b>
𝗥𝗰𝗹𝗼𝗻𝗲 𝗣𝗮𝘁𝗵       :<b>{rccpath}</b>

𝗚𝗱𝗿𝗶𝘃𝗲 𝗧𝗼𝗸𝗲𝗻      :<b>{tokenmsg}</b>
𝗚𝗱𝗿𝗶𝘃𝗲 𝗜𝗗         :<b>{gdrive_id}</b>
𝗜𝗻𝗱𝗲𝘅 𝗟𝗶𝗻𝗸        :<b>{index}</b>

𝗦𝘁𝗼𝗽 𝗗𝘂𝗽𝗹𝗶𝗰𝗮𝘁𝗲    :<b>{sd_msg}</b>
𝗗𝗲𝗳𝗮𝘂𝗹𝘁 𝗨𝗽𝗹𝗼𝗮𝗱    :<b>{dum}</b>
𝗨𝗽𝗹𝗼𝗮𝗱 𝗣𝗮𝘁𝗵𝘀     :<b>{upload_paths}</b>
𝗡𝗮𝗺𝗲 𝗦𝘂𝗯𝘀𝘁𝗶𝘁𝘂𝘁𝗲  :<b>{ns_msg}</b>
𝗘𝘅𝘁𝗲𝗻𝘀𝗶𝗼𝗻 𝗙𝗶𝗹𝘁𝗲𝗿   :<b>{ex_ex}</b>
𝗬𝗧-𝗗𝗟𝗣 𝗢𝗽𝘁𝗶𝗼𝗻𝘀   :<b>{escape(ytopt)}</b>
"""
